...
media4 = Media.create(name: "Top Gear", description: 'Zoom Zoom', picture: 'https://static.wikia.nocookie.net/topgear/images/6/62/TG_S22_Promo_Image.jpg/revision/latest?cb=20200116225107')
...
plat4 = Platform.create(name: "HBO", user_id: user4.id,)
plat5 = Platform.create(name: "Amazon Video", user_id: user5.id,)
plat5 = Platform.create(name: "PeacockTV", user_id: user6.id,)
...
cat3 = Category.create(name: "Video Games", platform_id: plat3.id, genre_id: gen4.id)
cat4 = Category.create(name: "Podcasts", platform_id: plat4.id, genre_id: gen5.id)
cat5 = Category.create(name: "Books", platform_id: plat5.id, genre_id: gen3.id)
